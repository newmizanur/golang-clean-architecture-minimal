...
func (_q *AddressQuery) QueryContact() *ContactQuery {
...
func (_q *AddressQuery) WithContact(opts ...func(*ContactQuery)) *AddressQuery {
	query := (&ContactClient{config: _q.config}).Query()
...
//		GroupBy(address.FieldContactID).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
func (_q *AddressQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Address, error) {
	...
	if query := _q.withContact; query != nil {
		if err := _q.loadContact(ctx, query, nodes, nil,
			func(n *Address, e *Contact) { n.Edges.Contact = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *AddressQuery) loadContact(ctx context.Context, query *ContactQuery, nodes []*Address, init func(*Address), assign func(*Address, *Contact)) error {
...
func (_q *AddressQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withContact != nil {
			_spec.Node.AddColumnOnce(address.FieldContactID)
		}
	}
