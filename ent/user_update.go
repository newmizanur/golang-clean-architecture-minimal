...
func (_u *UserUpdate) AddContactIDs(ids ...string) *UserUpdate {
...
func (_u *UserUpdate) RemoveContactIDs(ids ...string) *UserUpdate {
...
// AddContactIDs adds the "contacts" edge to the Contact entity by IDs.
func (_u *UserUpdateOne) AddContactIDs(ids ...string) *UserUpdateOne {
	_u.mutation.AddContactIDs(ids...)
	return _u
}
...
// RemoveContactIDs removes the "contacts" edge to Contact entities by IDs.
func (_u *UserUpdateOne) RemoveContactIDs(ids ...string) *UserUpdateOne {
	_u.mutation.RemoveContactIDs(ids...)
	return _u
}
